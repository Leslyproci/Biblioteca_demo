view: tabla_biblioteca {
  sql_table_name: `analitica-demos.Demo.tabla_biblioteca`
    ;;

  dimension: anio_registro_usuario_sistema {
    label: "Año registro en el sistema"
    type: number
  ...
  dimension: medio_de_preferenica_de_aviso {
    label: "Medio de preferencia de aviso"
    type: string
